...
<form action="pconfirm.php" method="post">
<h3>Please Scan your Card</h3>
<p>You have decided to buy the <?php echo $package ?> shilling Package.</p>

Card Identification:<input type="password" name="card"><br>
